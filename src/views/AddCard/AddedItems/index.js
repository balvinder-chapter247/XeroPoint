...

                {
                    items && items.length ?
                                    ...
                                    <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5" key={cartItem.id}>
                                        ...
                                        <div className="flex w-2/5">
                                            <div className="flex flex-col justify-between  flex-grow">
                                                <span className="font-bold text-sm">{cartItem.courseName}</span>
                                            </div>
                                        </div>
                                        <span className="text-center w-1/5 font-semibold text-sm">${cartItem.coursePrice}</span>
                                        <div className="flex justify-center w-1/5">
                                        <i className="fa-solid fa-trash-can delete-button" 
                                        onClick={()=>deleteItem(cartItem.index)}
                        ...
                        <div className="empty_cart text-center mt-16">
                            <img src="./images/shopping-cart.png" alt="" className="mx-auto w-16 mb-2" />
                            <h5>Your Cart is Empty</h5>
                            <Link to="/my-courses">
                            <button className="mx-auto bg-theme-color hover:bg-blue-700 px-4 py-2 rounded text-white">Continue Shopping</button>
                            </Link>
                        </div>
                }
