          ...
          <div className='grid gap-4 grid-cols-4'>
            <div className='col-span-3'>
              <div className='course-details-left'>
                ...
                <div className='course_info flex items-center mb-12'>
                  <div className='teacher_info flex items-center mr-12'>
                    ...
                    <div className='short_info'>
                      <span className='mb-0 fomt-medium text-sm short_title'>
                        Teacher
                      </span>
                ...
                <img
                  src='./images/course-details-1.jpg'
                  className='rounded'
                  alt=''
                />
                <div className='pt-6'>
                  <ul
                    className='course-tab nav nav-tabs flex flex-col md:flex-row flex-wrap list-none border-b-0 mb-4 bg-white py-3 rounded'
                    id='tabs-tab'
                    role='tablist'
                  >
                    <li className='nav-item' role='presentation'>
                      ...
                      '
                        ...
                        aria-selected='true'
                      >
                        <i className='fas fa-layer-group pr-1'></i> Description
                      </a>
                    </li>
                    <li className='nav-item' role='presentation'>
                      <a
                        ...
                        focus:border-transparent
                      '
                        id='tabs-curriculum-tab'
                        data-bs-toggle='pill'
                        data-bs-target='#tabs-curriculum'
                        role='tab'
                        aria-controls='tabs-curriculum'
                        aria-selected='false'
                      >
                        <i className='fa fa-book pr-1'></i> Curriculum
                      </a>
                    </li>
                    <li className='nav-item' role='presentation'>
                      <a
                      ...
                      '
                        ...
                        aria-selected='false'
                      >
                        <i className='fa fa-star pr-1'></i> Reviews
                      </a>
                    </li>
                    <li className='nav-item' role='presentation'>
                      <a
                      ...
                      '
                        ...
                        aria-selected='false'
                      >
                        <i className='fa fa-user pr-1'></i> About Author
                      </a>
                    </li>
                  </ul>
                  <div className='tab-content' id='tabs-tabContent'>
                    ...
                    <div
                      ...
                      id='tabs-curriculum'
                      role='tabpanel'
                      aria-labelledby='tabs-curriculum-tab'
                    >
                      <CoursesCurriculum />
                    </div>
                    <div
            ...
            <div className=''>
              <div className='bg-white course-sidebox'>
                <ul className='price flex items-center p-8'>
                  <li>$ 72 USD</li>
                  <li className='line-through leading-4 font-medium text-sm'>
                    $ 95 USD
                  </li>
                  <li className='leading-4 font-medium p-1 rounded text-sm'>
                    25% OFF
                  </li>
                </ul>
                <ul className='price-courses p-8'>
                  <li>
                    <i className='fa fa-user'></i> Instructor{" "}
                    <span className='float-right'>Penny Tool</span>
                  </li>
                  <li>
                    <i className='fa fa-tag'></i> Subject{" "}
                    <span className='float-right'>IT &amp; Software</span>
                  </li>
                  <li>
                    <i className='fa fa-users'></i> Enrolled{" "}
                    <span className='float-right'>146 students</span>
                  </li>
                  <li>
                    <i className='fa fa-clock'></i> Duration{" "}
                    <span className='float-right'>2 weeks</span>
                  </li>
                  <li>
                    <i className='fa fa-book'></i> Lectures{" "}
                    <span className='float-right'>4 lectures</span>
                  </li>
                  <li>
                    <i className='fa fa-map'></i> Language{" "}
                ...
                <div className='px-8 pb-8'>
                  <Link
                    to=''
                    className='blue-btn text-white font-semibold uppercase py-3 px-8 rounded block text-center'
                  >
                    Add to cart{" "}
                  </Link>
                  <div className='share font-medium text-center mt-4 flex items-center justify-center'>
                    Share this course
                    <i
                      className='fa fa-share-alt ml-2  flex items-center justify-center'
                      aria-hidden='true'
                    ></i>
                  </div>
                </div>
              ...
              <div className='bg-white course-sidebox p-8 mt-4'>
                ...
                <div className='sidebar-course flex items-center mt-6'>
                  <img
                    ...
                    className='course_img object-cover mr-4'
                    alt=''
                  />
                  <div>
                    ...
                    <div className='font-medium text-sm'>
                      <Link to='#' className='course_name'>
                        Development
                      </Link>
                    </div>
                    <div className='course_price font-medium text-sm'>
                      $54.00
                    </div>
                  </div>
                </div>
