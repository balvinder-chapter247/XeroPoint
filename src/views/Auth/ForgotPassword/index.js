            ...
            <div className='login-box shadow-lg'>
              <div className='grid grid-cols-3 items-center my-10'>
                <div className='text-center left text-white p-6'>
                  ...
                  <Link
                    to={AppRoutes.LOGIN}
                    className='block py-2 px-6 rounded-full signin-btn m-auto mt-6 uppercase font-medium'
                  >
                    Login
                  </Link>
                </div>
                  ...
                  <div className='login-signup-box'>
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      <div className='text-center'>
                        <button
                          type='submit'
                          className='bg-theme-color block w-full hover:bg-blue-700 text-white font-semibold py-2 px-8 mt-6 rounded-full'
                        >
                          Request reset link
                        </button>
                      </div>
